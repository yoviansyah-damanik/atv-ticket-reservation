...
<body>
    ...
    <div style="float:right" class="w-100 text-end">
        <h5>
            {{ __('Reservation Report for :month :year', ['month' => Carbon::createFromFormat('m', $month)->translatedFormat('F'), 'year' => $year]) }}
        </h5>
    </div>
            ...
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>{{ Carbon::parse($item['date'])->translatedFormat('d F Y') }}</td>
