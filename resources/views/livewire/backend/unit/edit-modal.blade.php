<div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            <label class="form-label" for="edit_register_number">{{ __('Register Number') }} <span
                    class="text-danger">(*)</span></label>
            <input type="text" class="form-control" id="edit_register_number" wire:model='register_number'
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="edit_status" wire:model='status'>
                @foreach (App\Enums\UnitType::getValues() as $key => $status)
                    <option value="{{ $status }}">{{ __(Str::headline($status)) }}</option>
                @endforeach
            </select>
            @error('status')
                <div class="mt-1 small text-danger">
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary ms-auto" wire:click='update_unit'>
