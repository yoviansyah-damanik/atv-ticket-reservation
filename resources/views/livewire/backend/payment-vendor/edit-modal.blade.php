<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title">
            {{ __('Edit :edit', ['edit' => __('Payment Vendor')]) }}
        </h5>
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="edit_name" wire:model='name'
                placeholder="{{ __('Payment Vendor Name') }}">
            @error('name')
                <div class="mt-1 small text-danger">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            <label class="form-label" for="edit_account_number">{{ __('Account Number') }} <span
                    class="text-danger">(*)</span></label>
            <input type="text" class="form-control" id="edit_account_number" wire:model='account_number'
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary ms-auto" wire:click='update_payment_vendor'>
